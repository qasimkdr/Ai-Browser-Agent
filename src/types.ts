...
export type PageElement={id:string;tag:string;role?:string;type?:string;name?:string;label?:string;text?:string;placeholder?:string;value?:string;checked?:boolean;disabled?:boolean;required?:boolean;href?:string};
